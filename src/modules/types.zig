...
pub const Glyph = struct {
    ...
    fg: u32 = config.Config.colors.default_foreground, // 前景色索引：默认前景色
    bg: u32 = config.Config.colors.default_background, // 背景色索引：默认背景色
...
pub const Term = struct {
    ...
    // ========== 分配器 ==========
    allocator: std.mem.Allocator, // 内存分配器：用于动态分配（屏幕缓冲区、历史缓冲区等）
